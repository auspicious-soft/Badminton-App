...
class PgUploadscore extends StatefulWidget {
  const PgUploadscore({super.key});

  @override
  State<PgUploadscore> createState() => _PgUploadscoreState();
}

class _PgUploadscoreState extends State<PgUploadscore> {
  @override
  void initState() {
    super.initState();
  }
